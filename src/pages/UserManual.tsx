    ...
    <div className="max-w-4xl mx-auto space-y-8 pb-12">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 print:hidden">
        <div>
          ...
          <p className="text-muted-foreground">Comprehensive documentation for the {BRAND.product} platform.</p>
        </div>
        ...
        <Card className="print:shadow-none print:border-none">
          <CardContent className="p-8 print:p-0">
            <div className="mb-8 border-b pb-4">
              <h1 className="text-4xl font-extrabold mb-2">{BRAND.product} User Guide</h1>
            ...
            <section className="space-y-4 mb-8">
              ...
              <p>
                {BRAND.product} is a comprehensive ERP (Enterprise Resource Planning) solution designed to streamline your business operations. 
                From tracking sales and inventory to managing complex accounting and payroll, {BRAND.product} provides a unified platform 
            ...
            <div className="mt-12 pt-8 border-t text-center text-sm text-muted-foreground print:text-xs">
              <p>Generated by {BRAND.product}</p>
