/**
 * South Africa 2024/2025 — domain-composed legislation package.
 */
...
const validationRules: ValidationRulesBlock = {
  requireEmployeeTaxReference: statutoryConstant(true, {
    ...
    effectiveFrom: '2024-03-01', effectiveTo: '2025-02-28', legislationVersion: '2024.2.0',
  }),
...
export const RULE_SET_2024_2025: CountryLegislationPackage = {
  metadata: withChecksum(checksum),
  ...draft,
};

export default RULE_SET_2024_2025;
