/**
 * South Africa 2026/2027 — domain-composed legislation package.
 */
...
const validationRules: ValidationRulesBlock = {
  requireEmployeeTaxReference: statutoryConstant(true, {
    ...
    effectiveFrom: '2026-03-01', effectiveTo: '2027-02-28', legislationVersion: '2026.2.0',
  }),
...
export const RULE_SET_2026_2027: CountryLegislationPackage = {
  metadata: withChecksum(checksum),
  ...draft,
};

export default RULE_SET_2026_2027;
