...
import { aggregateAuditTrail } from './audit';
...
} from './engines/directorsPayeEngine';
...
import { runMedicalTaxCreditEngine } from './engines/medicalTaxCreditEngine';
...
import { resolveRuleSetForPayroll } from './registry';
import type {
  JournalLine,
...
import { createAuditStep, ENGINE_VERSION, roundCurrency } from './utils';
...
> & {
  ...
  /** Optional; defaults to grossEarnings when omitted. */
...
/** Statutory breakdown lines for audit and reconciliation (not GL account IDs). */
