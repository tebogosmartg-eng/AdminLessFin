...
import { getSortedRules } from './catalogue.ts';
import { RULE_CALCULATORS, applyRuleResult, isRuleEnabled } from './rules.ts';
import { roundCurrency } from './paye.ts';
import type {
  CalculationState,
...
export function buildStatutoryEngineConfig(
  ...
  const ctx: PayrollRulesContext = {
    employee: { id: 'statutory', salaryAmount: 0, salaryPeriod: 'monthly' },
