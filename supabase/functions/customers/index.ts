...
// ARCHITECTURE NOTE:
// This function acts as a secure API gateway for all customer-related database operations.
// The frontend should never query the 'customers' table directly. Instead, it should invoke this function.
serve(async (req) => {
